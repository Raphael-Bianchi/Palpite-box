  ...
  return (
    <div className='pt-6'>
      ...
      <p className='text-center mb-6'>
        O restaurante X sempre busca por atender melhor os seus clientes.<br />
      ...
      {!sucess && <div className='w-1/5 mx-auto'>
        ...
        <button onClick={save} className='mb-4 bg-blue-400 px-12 py-4 font-bold rounded-lg shadow-lg hover:shadow'>Salvar</button>
      </div>}
      {sucess && <div className='w-2/3 mx-auto'>
